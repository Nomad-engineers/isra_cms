...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'client', 'moderator');
  CREATE TYPE "public"."enum_users_plan_status" AS ENUM('active', 'trialing', 'paused', 'canceled', 'past_due', 'overdue', 'expired', 'inactive', 'active_until_period_end');
  CREATE TYPE "public"."enum_users_plan_billing_cycle" AS ENUM('month', 'year');
  CREATE TYPE "public"."enum_rooms_type" AS ENUM('live', 'auto');
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'runRoom');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'runRoom');
  CREATE TABLE "users" (
  	...
  	"plan_id" integer,
  	"plan_status" "enum_users_plan_status",
  	"plan_billing_cycle" "enum_users_plan_billing_cycle",
  	"plan_end_date" timestamp(3) with time zone,
  	"plan_canceled_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "rooms" (
  	...
  	"type" "enum_rooms_type" DEFAULT 'live' NOT NULL,
  	...
  	"btn_url" varchar,
  	"show_btn" boolean DEFAULT true,
  	"show_chat" boolean DEFAULT true,
  	"is_volume_on" boolean DEFAULT true,
  ...
  ALTER TABLE "rooms" ADD CONSTRAINT "rooms_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "scenario" ADD CONSTRAINT "scenario_room_id_rooms_id_fk" FOREIGN KEY ("room_id") REFERENCES "public"."rooms"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_scenario_fk" FOREIGN KEY ("scenario_id") REFERENCES "public"."scenario"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."payload_preferences"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  CREATE INDEX "users_avatar_idx" ON "users" USING btree ("avatar_id");
  CREATE INDEX "users_plan_idx" ON "users" USING btree ("plan_id");
  ...
  CREATE INDEX "rooms_logo_idx" ON "rooms" USING btree ("logo_id");
  CREATE INDEX "rooms_user_idx" ON "rooms" USING btree ("user_id");
  ...
  CREATE INDEX "scenario_room_idx" ON "scenario" USING btree ("room_id");
  CREATE INDEX "scenario_updated_at_idx" ON "scenario" USING btree ("updated_at");
  CREATE INDEX "scenario_created_at_idx" ON "scenario" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_scenario_id_idx" ON "payload_locked_documents_rels" USING btree ("scenario_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_users_plan_status";
  DROP TYPE "public"."enum_users_plan_billing_cycle";
  DROP TYPE "public"."enum_rooms_type";
